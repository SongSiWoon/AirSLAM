...
def generate_launch_description():
    return LaunchDescription([
        # Declare arguments
        DeclareLaunchArgument('config_path', default_value='air_slam/configs/visual_odometry/vo_oivio.yaml'),
        DeclareLaunchArgument('dataroot', default_value='/media/data/datasets/oivio/selected_seq/MN_015_GV_01'),
        DeclareLaunchArgument('camera_config_path', default_value='air_slam/configs/camera/oivio.yaml'),
